export default class OdeTitleMenu {
    ...
    setChangeTitle() {
        ...
        title.addEventListener('click', () => {
            ...
            titleContainer.classList.add('title-editing');
            titleContainer.classList.remove('title-not-editing');
            setTimeout(() => {
            ...
            const finishEditing = () => {
                ...
                title.scrollTop = 0;
                titleContainer.classList.remove('title-editing');
                titleContainer.classList.add('title-not-editing');
    ...
    setMenuTitle() {
        this.titleButton.addEventListener('click', (e) => {
            e.stopPropagation();
            this.titleMenu.classList.toggle('hidden');
        });
        document
            .querySelector('.title-action-text')
            .addEventListener('click', (e) => {
                e.stopPropagation();
                this.titleMenu.classList.toggle('hidden');
                this.odeTitleMenuHeadElement.click();
            });
        document
            .querySelector('.title-action-info')
            .addEventListener('click', (e) => {
                e.stopPropagation();
                this.titleMenu.classList.toggle('hidden');
                document.querySelector('#head-top-settings-button').click();
            });
    }
