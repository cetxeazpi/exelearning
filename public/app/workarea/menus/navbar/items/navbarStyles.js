export default class NavbarFile {
    ...
    makeMenuThemeDelete(themeId) {
        ...
        const icon = document.createElement('span');
        icon.classList.add('small-icon', 'delete-icon-green');
        li.appendChild(icon);
    ...
    makeElementInfoTheme(theme, tab) {
        ...
        const backIcon = document.createElement('div');
        backIcon.classList.add('small-icon', 'arrow-left-icon');
        backBtn.appendChild(backIcon);
        backBtn.addEventListener('click', () => {
            if (tab === 'base') {
                this.buildBaseListThemes();
    ...
    makeThemesFormTabs(tabs) {
        ...
        tabs.forEach((data) => {
            ...
            link.classList.add('nav-link', 'exe-tab', 'small-icon');
            if (data.active) {
            ...
            iconInfo.classList.add('large-icon');
            switch (data.id) {
                case 'informacin':
                    ...
                    break;
                case 'textosyenlaces':
                    iconInfo.classList.add('palette-icon-green');
                    link.append(iconInfo);
                    break;
                case 'encabezado':
                    iconInfo.classList.add('info-icon-green');
                    link.append(iconInfo);
                    break;
                default:
    ...
    buttonSave(theme) {
        ...
        btn.type = 'button';
        btn.classList.add('btn', 'btn-save-theme');
        btn.title = _('Save');
        const icon = document.createElement('span');
        icon.classList.add('large-icon', 'save-icon');
        btn.append(icon);
