...
export default class modalOpenUserOdeFiles extends Modal {
    ...
    makeFilterForList(selector, placeholder) {
        ...
        const icon = document.createElement('span');
        icon.classList.add('ode-search-icon');
        icon.setAttribute('aria-hidden', 'true');
        icon.innerHTML = `
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
     viewBox="0 0 20 20" fill="none" focusable="false">
  ...
  <path d="M17.5 12.5V13.5C17.5 14.9001 17.5 15.6002 17.2275 16.135C16.9878 16.6054 16.6054 16.9878 16.135 17.2275C15.6002 17.5 14.9001 17.5 13.5 17.5H6.5C5.09987 17.5 4.3998 17.5 3.86502 17.2275C3.39462 16.9878 3.01217 16.6054 2.77248 16.135C2.5 15.6002 2.5 14.9001 2.5 13.5V12.5M14.1667 6.66667L10 2.5M10 2.5L5.83333 6.66667M10 2.5V12.5" stroke="#344054" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        uploadDiv.append(inputUpload, inputMultiple, buttonUpload);
        return uploadDiv;
    }
